          ...
          <img src={ep_logo} className="App-logo pulse" alt="logo" />
              ...
              <div className='seriesPanel'>
                  ...
                  <ul className='AtAGlance'>
                      ...
                      <li id="register"><b>Rough Rider Championship | 2/20/2022 | </b> <a href="https://www.bikereg.com/rrbash?fbclid=IwAR15ysZOzmGVdrfuewZBzFYutW9Kc1Pe2enTdEnDtvfsEMuHeTtqkbpEUHc"  target="_blank" class="btn btn-danger" role="button">REGISTER</a></li>
