...
function App() {
  ...
  const data = [
    { news: 'Check this run', link: "https://www.instagram.com/p/CZbBCDIloa_/", caption: 'Check this run on part of one of the stages for ROUGHRIDER BASH, EP ENDURO 4 🤘🏻🤘🏻 Getting closer!! Go to bike reg and grab your spot 🤙🏻🤙🏻 Video Courtesy of Mad Max little shredder 👊🏻' },
